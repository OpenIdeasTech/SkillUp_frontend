    ...
    <nav className="w-full text-white font-poppins relative z-50">
      <div className="flex items-center justify-between px-6 py-4 md:px-10">
        ...
        <div className="hidden lg:flex gap-4">
          <Button variant="ghost" className="text-xl font-medium">Criar conta</Button>
          <Button className="text-xl px-10 py-2 rounded-xl font-medium"><span>Login</span></Button>
        </div>
      </div>
    </nav>
  );
